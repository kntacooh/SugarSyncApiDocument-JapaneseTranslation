...
* [Add keys](#adding-keys)
* [Disable keys](#disabling-keys)
* [Enable keys](#enabling-keys)
* [Create an application](#creating-an-application)
* [Edit an application](#editing-an-application)
* [Disable an application](#disabling-an-application)
* [Enable an application](#enabling-an-application)
* [Delete an application](#deleting-an-application)
...
> **Your Access Keys:**
>
|[]|Access Key ID|Private Access Key|Status|Creation Time|
|:-:|:-|:-|:-|:-|
|[]|MTl2NzcxMz3NjE0ODl4MDE2|ZjliNWUzOGNiNmNiNDVhZjliYWJjYjE0OGQ3MDlzM2U|Enabled|05/21/2012 08:40|
...
|:-:|:-|:-|:-|:-|
|[]|MTl2NzcxMz3NjE0ODl4MDE2|ZjliNWUzOGNiNmNiNDVhZjliYWJjYjE0OGQ3MDlzM2U|Enabled|05/21/2012 08:40|
|[]|MTl2NzcxMzM3NjE1NDcyODlz|MDRhMDVkZjl2NjBlNGMxZThhNjQ3YmUzZjl3YWUyMWl|Enabled|05/21/2012 08:51|
...
|:-:|:-|:-|:-|:-|
|[]|MTl2NzcxMz3NjE0ODl4MDE2|ZjliNWUzOGNiNmNiNDVhZjliYWJjYjE0OGQ3MDlzM2U|Enabled|05/21/2012 08:40|
|[]|MTl2NzcxMzM3NjE1NDcyODlz|MDRhMDVkZjl2NjBlNGMxZThhNjQ3YmUzZjl3YWUyMWl|**Disabled**|05/21/2012 08:51|
...
> ```
>
> **Support URL** (64 characters)
>
> ```
>
> ```
>
> **Support Email** (64 characters)
>
> ```
>
> ```
>
> **Icon (16X16)** (jpeg,jpg,gif,png)
>
> -----
>
> **Icon (64X64)** (jpeg,jpg,gif,png)
>
> ```
>
> ```
>
> **Icon (128X128)** (jpeg,jpg,gif,png)
>
> ```
>
> ```
...
Notice that SugarSync enables the app and also assigns it an app ID. The app ID uniquely identifies the application. You app will need to specify the app ID as well as the pertinent access key ID-private access key pair when it requests a refresh token for authorization to access the SugarSync API. (See Getting Authorization for further details about authorization.)

Editing an Application

You can edit an application. You do this to change the registration information for the app. To edit an application, click Update app button in the row that lists the app. This will display an "Edit app" dialog for you to change the registration information about the application:
